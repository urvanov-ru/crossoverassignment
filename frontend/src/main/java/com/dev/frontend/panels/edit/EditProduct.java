...
public class EditProduct extends EditContentPanel
{
	...
	public boolean bindToGUI(Object o) 
	{
	    ...
	    txtQuantity.setText(NumberFormat.getIntegerInstance().format(product.getQuantity()));
		return true;
	}
	...
	public Object guiToObject()
	{
		...
		try {
            ...
            product.setPrice((BigDecimal)decimalFormat.parse(txtPrice.getText()));
        } catch (ParseException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
		try {
            product.setQuantity(NumberFormat.getIntegerInstance().parse(txtQuantity.getText()).intValue());
        } catch (ParseException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
